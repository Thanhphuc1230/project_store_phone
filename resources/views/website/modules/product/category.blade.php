            ...
            <div class="col-12">
                <div class="breadcrumb_content">
                    <ul>
                        ...
                        <li>shop {{$category_name->name_cate}}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="shop_toolbar_wrapper">
                    ...
                    <div class="page_amount " ><h4>{{$category_name->name_cate}}</h4></div>
                ...
                <div class="row no-gutters shop_wrapper">
                    ...
                    <div class="col-lg-3 col-md-4 col-12 {{Str::of($item->price)->slug(".") }}">
                            ...
                            <figure>
                                <div class="product_thumb">
                                    ...
                                    <div class="action_links">
                                        <ul>
                                            <li class="wishlist"><a href="{{route('website.addToWishList', ['id'=>$item->id])}}" data-tippy-placement="top" data-tippy-arrow="true" data-tippy-inertia="true" data-tippy="Add to Wishlist">
                                ...
                                <div class="product_content list_content">
                                    ...
                                    <div class="action_links">
                                        <ul>
                                            <li class="wishlist"><a href="{{route('website.addToWishList', ['id'=>$item->id])}}" title="Add to Wishlist"><i class="fa-regular fa-heart"></i>Add to Wishlist</a></li>
